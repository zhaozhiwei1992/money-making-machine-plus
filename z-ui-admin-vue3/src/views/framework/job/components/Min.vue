...
// 计算属性
const cycleTotal = computed(() => `${checkNum(cycle01.value, 0, 58)}-${checkNum(cycle02.value, cycle01.value + 1, 59)}`);
const averageTotal = computed(() => `${checkNum(average01.value, 0, 58)}/${checkNum(average02.value, 1, 59 - average01.value || 0)}`);
