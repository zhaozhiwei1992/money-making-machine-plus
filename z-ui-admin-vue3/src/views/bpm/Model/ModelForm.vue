...
const formList: any = ref([]) // 流程表单的下拉框的数据
  ...
  try {
    ...
    if (formType.value === 'create') {
      ...
      await ElMessageBox.alert(
        `<strong>新建模型成功！</strong>后续需要执行如下 4 个步骤：<div>1. 点击【修改流程】按钮，配置流程的分类、表单信息</div><div>2. 点击【设计流程】按钮，绘制流程图</div><div>3. 点击【分配规则】按钮，设置每个用户任务的审批人</div><div>4. 点击【发布流程】按钮，完成流程的最终发布</div>另外，每次流程修改后，都需要点击【发布流程】按钮，才能正式生效！！！`,
        '重要提示',
        {
