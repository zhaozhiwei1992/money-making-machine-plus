<template>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column label="任务状态" prop="suspension_state">
        <template #default="scope">
          <el-tag v-if="scope.row.suspension_state === 1" type="success">激活</el-tag>
          <el-tag v-if="scope.row.suspension_state === 2" type="warning">挂起</el-tag>
        </template>
      </el-table-column>
