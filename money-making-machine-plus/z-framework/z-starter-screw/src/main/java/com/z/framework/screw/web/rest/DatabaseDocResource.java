...
import com.z.framework.screw.config.DataSourceProperties;
...
public class DatabaseDocResource {
    ...
    public DatabaseDocResource(DataSourceProperties dataSourceProperties) {
    ...
    private void doExportFile(EngineFileType fileOutputType, Boolean deleteFile,
        ...
        try {
            ...
            response.setHeader("Content-Disposition", "attachment;filename=" + URLEncoder.encode(downloadFileName,
                    "UTF-8"));
            response.setContentType(MediaType.APPLICATION_OCTET_STREAM_VALUE);
            // 输出附件
            IoUtil.write(response.getOutputStream(), false, FileUtil.readBytes(filePath));
